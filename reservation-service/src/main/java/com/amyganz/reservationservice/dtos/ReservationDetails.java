...
import com.amyganz.reservationservice.helpers.AppHelper;
...
public class ReservationDetails implements Serializable {
    ...
    public String toString() {
        return "{" +
                ...
                "\"check_in_date\": \"" + AppHelper.convertSDF(check_in_date) + "\"," +
                "\"check_out_date\": \"" + AppHelper.convertSDF(check_out_date) + "\"," +
